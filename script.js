  ...
  document.getElementById("국내사망자차이").innerHTML = String(Number(국내현황[3]).toLocaleString());
  document.getElementById("국내완치자차이").innerHTML = String(Number(국내현황[5]).toLocaleString());
