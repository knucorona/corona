...
document.getElementById("Now").innerHTML = '(업데이트 : '+new_year+'년 '+(new_month+1)+'월 '+new_day+'일, '+new_hour+':'+new_min+')';
  ...
  document.getElementById("w_infect_1").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[2].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[1].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_1").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[2].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[1].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_2").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[3].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[2].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_2").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[3].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[2].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_3").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[4].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[3].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_3").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[4].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[3].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_4").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[5].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[4].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_4").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[5].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[4].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_5").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[6].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[5].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_5").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[6].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[5].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_6").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[7].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[6].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_6").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[7].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[6].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_7").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[8].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[7].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_7").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[8].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[7].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_8").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[9].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[8].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_8").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[9].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[8].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_9").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[10].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[9].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_9").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[10].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[9].사망자증가수.toLocaleString()) +') </span>';
  ...
  document.getElementById("w_infect_10").innerHTML = '<span style="color:#C51C1C"> <b>' + String(세계확진자[11].확진자수.toLocaleString()) + '</b> </span> <br> <span style="color:#DA5672; font-size:11px"> (+'+ String(세계확진자증가수[10].확진자증가수.toLocaleString()) +') </span>';
  document.getElementById("w_death_10").innerHTML = '<span style="color:#4C525D"> <b>' + String(세계확진자[11].사망자수.toLocaleString()) + '</b> </span> <br> <span style="color:#4C525D; font-size:11px"> (+'+ String(세계확진자증가수[10].사망자증가수.toLocaleString()) +') </span>';
