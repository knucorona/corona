...
document.getElementById("Now").innerHTML = '(업데이트 : '+new_year+'년 '+(new_month+1)+'월 '+new_day+'일, '+new_hour+':'+new_min+')';
  ...
  document.getElementById("mobile_cured").innerHTML = String(세계현황[1].toLocaleString())+" | ";
  document.getElementById("mobile_death").innerHTML = String(세계현황[2].toLocaleString()); 
