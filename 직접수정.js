...
//(직접수정 3)
var dayXaxis = ['10.19','10.20','10.21',
'10.22','10.23','10.24','10.25','10.26','10.27','10.28'
]

//(직접수정 4) 날짜 추가
var plusXaxis = ['10.19','10.20','10.21',
'10.22','10.23','10.24','10.25','10.26','10.27','10.28'
]

//(직접수정 6) 일일 전체 확진자
var AllDayData = [
25333,25422,25543,25698,25775,25836,25955,26043,26146,26271
]

//(직접수정 7) 일일 확진자 증감추이
var plusData = [58,89,121,155,77,61,119,88,103,125
]
