...
//(직접수정 3)
var dayXaxis = ['11.1','11.2',
'11.3','11.4','11.5','11.6','11.7','11.8','11.9','11.10'
]

//(직접수정 4) 날짜 추가
var plusXaxis = ['11.1','11.2',
'11.3','11.4','11.5','11.6','11.7','11.8','11.9','11.10'
]

//(직접수정 6) 일일 전체 확진자
var AllDayData = [
26732,26807,26925,27050,27195,27284,27427,27553,27653,27799
]

//(직접수정 7) 일일 확진자 증감추이
var plusData = [97,75,118,125,145,89,143,126,100,146
]
