...
//(직접수정 3)
var dayXaxis = ['10.12','10.13','10.14','10.15',
'10.16','10.17','10.18','10.19','10.20','10.21'
]

//(직접수정 4) 날짜 추가
var plusXaxis = ['10.12','10.13','10.14','10.15',
'10.16','10.17','10.18','10.19','10.20','10.21'
]

//(직접수정 6) 일일 전체 확진자
var AllDayData = [
24805,24878,24988,25035,25108,25199,25275,25333,25422,25543
]

//(직접수정 7) 일일 확진자 증감추이
var plusData = [102,73,110,47,73,91,76,58,89,104
]
